...
# total model
def single_model(images, weight_decay=1e-5, is_training=True):
    # get ResNet vars
    ...
    with tf.variable_scope('feature_fusion', values=[end_points.values]):
        ...
        with slim.arg_scope([slim.conv2d],
            ...
            pred = slim.conv2d(fusion, 1, 3, activation_fn=None, normalizer_fn=None)
            pred = unpool(pred, get_tensor_pad_size(images))
